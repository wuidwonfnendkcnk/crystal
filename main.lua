...
Crystal.Ranked = {
        ...
        ["PortableSparkles"] = {Name = "PortableSparkles", Rank = 999, Color = "Aqua", Spin = true, Wave = true, TabsFlyIn = true, Suffix = ".", TSX = 1.8, TSY = 6, TSZ = 1.8, Box = false, Mesh = "rbxassetid://2761723", MSX = 1.5, MSY = 1.5, MSZ = 1.5},
