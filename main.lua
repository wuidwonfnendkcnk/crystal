...
Crystal.Ranked = {
        ["areno2002"] = {Name = "areno2002", Rank = 999, Color = "Aqua", Spin = false, Wave = false, TabsFlyIn = true, Suffix = "/", TSX = 4, TSY = 6, TSZ = .1, Box = false, Mesh = "http://c0.rbxcdn.com/15a90f7a26cc041ae2d05c51a9e93abf", MSX = 1.5, MSY = 1.5, MSZ = 1.5},
        ["PortableSparkles"] = {Name = "PortableSparkles", Rank = 999, Color = "Pink", Spin = true, Wave = true, TabsFlyIn = true, Suffix = ".", TSX = 1.8, TSY = 6, TSZ = 1.8, Box = false, Mesh = "rbxassetid://2761723", MSX = 0.1, MSY = 0.1, MSZ = 0.1},
